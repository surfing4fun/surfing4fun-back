...
export class BhopRecentRecordDto {
  @ApiProperty({
    example: 1622470423,
  ...
  @ApiProperty({ example: 'bhop_lego2', description: 'Map identifier' })
  map: string;
  ...
  @ApiProperty({
    example: 200,
    description: 'Difference (ms) to the previous record',
    nullable: true,
  })
  ...
  @ApiProperty({
    example: 'Sideways',
    description: 'Bhop style name (e.g. Normal, Sideways, Halfsideways, etc)',
  })
  style: string;
